...
class Profile(models.Model):
    ...
    linked = models.OneToOneField(User, null=True, blank=True)
...
class UserSettings(models.Model):
    user = models.OneToOneField(User, related_name="settings_user", on_delete=models.CASCADE, primary_key=True)
